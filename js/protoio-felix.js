...
var TituloEvento, SubtituloEvento;

off.addEventListener('click', () => {
    radio.classList.add('off');
    TituloEvento = "SIM 2020";
    SubtituloEvento = "XXXV Simpósio Sul de Microeletrônica";
    document.getElementById("toogleTitle").innerHTML = TituloEvento;
    document.getElementById("toogleSubtitle").innerHTML = SubtituloEvento; 
});

on.addEventListener('click', () => {
    radio.classList.remove('off');
    TituloEvento = "EMicro 2020";
    SubtituloEvento = "XXII Escola Sul de Microeletrônica";
    document.getElementById("toogleTitle").innerHTML = TituloEvento; 
    document.getElementById("toogleSubtitle").innerHTML = SubtituloEvento; 
});
